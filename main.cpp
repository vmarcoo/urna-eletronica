        ...
        if (CPF == 99999999999) {
            ...
            if (validosGov1 <= 50 && validosGov2 <= 50 && validosGov3 <= 50){
                ...
                // Segundo turno propriamente dito.
                    ...
                    if (validosGov1 > validosGov2 && validosGov1 > validosGov3 || idadeGov1 > idadeGov2 && idadeGov1 > idadeGov3){
                        segTurnGov1 = "Jorge da Silva (20)";

                        if(validosGov2 > validosGov3 || idadeGov2 > idadeGov3){
                    ...
                    if (validosGov2 > validosGov1 && validosGov2 > validosGov3 || idadeGov2 > idadeGov1 && idadeGov2 > idadeGov3){
                        segTurnGov1 = "Caio César Moreira (34)";

                        if (validosGov1 > validosGov3 || idadeGov1 > idadeGov3){
                    ...
                    if (validosGov3 > validosGov1 && validosGov3 > validosGov2 || idadeGov3 > idadeGov1 && idadeGov3 > idadeGov2){
                        segTurnGov1 = "Luana Hernandez (74)";

                        if (validosGov1 > validosGov2 || idadeGov1 > idadeGov2){
                            segTurnGov2 = "Jorge da Silva (20)";
                        }
            ...
            if (validosPres1 <= 50 && validosPres2 <= 50 && validosPres3 <= 50){
                ...
                // Segundo turno propriamente dito.
                    ...
                    if (validosPres1 > validosPres2 && validosPres1 > validosPres3 || idadePres1 > idadePres2 && idadePres1 > idadePres3){
                        segTurnPres1 = "Renato Junior (20)";

                        if (validosPres2 > validosPres3 || idadePres2 > idadePres3){
                    ...
                    if (validosPres2 > validosPres1 && validosPres2 > validosPres3 || idadePres2 > idadePres1 && idadePres2 > idadePres3){
                        segTurnPres1 = "Agenor Brasil (34)";

                        if (validosPres1 > validosPres3 || idadePres1 > idadePres3){
                    ...
                    if (validosPres3 > validosPres1 && validosPres3 > validosPres2 || idadePres3 > idadePres1 && idadePres3 > idadePres2){
                        segTurnPres1 = "Ednaldo Pereira (74)";

                        if (validosPres1 > validosPres2 || idadePres1 > idadePres2){
                            segTurnPres2 = "Renato Junior (20)";
                        }
